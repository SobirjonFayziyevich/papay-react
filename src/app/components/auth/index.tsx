...
let mb_nick: string = "",
    ...
    const handleUsername = (e: any) => {
        mb_nick = e.target.value; // evetni ichiga kirib valueni qabul qilib olamiz.
        // console.log(mb_nick);
    };
    const handlePhone = (e: any) => {
        mb_phone = e.target.value; // evetni ichiga kirib valueni qabul qilib olamiz.
        console.log(mb_phone);
    };
    const handlePassword = (e: any) => {
        mb_password = e.target.value; // evetni ichiga kirib valueni qabul qilib olamiz.
